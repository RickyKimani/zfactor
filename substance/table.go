...
// All contains every substance in this package, in the order
// they appear in the source data.
//
// It is intended for calculations and checks that range over the
// whole database. Callers must not modify the slice or the values
// it points to.
var All = []*Substance{
	Methane,
	Ethane,
